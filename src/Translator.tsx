      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-3">
          <button
            ...
            disabled={loading}
            className="px-4 py-2 rounded-md bg-primary-600 hover:bg-primary-700 text-white transition-colors flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
              <div className="flex items-center gap-2">
                ...
                <span className="text-center">Translating...</span>
              </div>
            ) : (
